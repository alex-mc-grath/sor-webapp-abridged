...
export const WorkingCarousel = ({ sliderImgs }) => {
  return (
    <Carousel interval={4000} swipeScrollTolerance={200} showThumbs={false} autoPlay={false} infiniteLoop centerMode={true} showStatus={false} showIndicators={false} showArrows={false} emulateTouch>
