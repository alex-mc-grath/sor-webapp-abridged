...
//           <h4>The implicit yet highly significant value of Account-based Marketing:</h4>
//           <ul>
...
//             <p>
//               <i class="fas fa-quote-left"></i> &nbsp;many CMOs understand that they’ll need to focus on disruptive growth, what often holds many of them back is the current culture of their
//               organizations.
//             </p>
//             <p>
//               Modern buyers have higher expectations toward brands: they need to stand for something bigger than the products/services they sell.
//             </p>
//             <p>They need to inspire, set new standards, have a clear purpose and emphasize certain values.
//             </p>
//             <p className="reference">
//               <strong>reference: </strong>
//               Living Business Report - Accenture
