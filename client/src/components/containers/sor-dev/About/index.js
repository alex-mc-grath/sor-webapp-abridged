...
export const About = () => {
  return (
    <StyledAbout>
      ...
      <h1>About SOR DEV</h1>
      <p>
        Based in Montreal, Canada, SOR DEV is a digital product agency specializing in tailor-made, highly perfomant, software solutions. We're passionate about highly innovative, modern-feeling, cutting-edge systems. Please find below our main types of
        deliverables.
      </p>
      <ul>
